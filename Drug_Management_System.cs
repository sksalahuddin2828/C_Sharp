...
class PharmacyManagementSystem
{
    ...
    private void ViewDrug()
    {
        ...
        if (!string.IsNullOrEmpty(name))
        {
            if (drugInventory.ContainsKey(name))
            {
                ...
                Console.WriteLine($"Price: {drugInventory[name]["price"]}");
                Console.WriteLine($"Quantity: {drugInventory[name]["quantity"]}");
            }
            else
            {
                Console.WriteLine("Drug not found in the inventory!");
    ...
    {
        Console.Write("Enter drug name to delete: ");
    ...
    private void GenerateSalesReport()
    {
        ...
        Console.WriteLine($"Total Sales: ${totalSales:.2f}");
    ...
    public void Menu()
    {
        while (true)
        {
            ...
            Console.WriteLine("2. Update Drug InformationConsole.WriteLine("3. View Drug Information");
